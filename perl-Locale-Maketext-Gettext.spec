...
%prep
%setup -q -n Locale-Maketext-Gettext-1.30
cd ..
%setup -q -T -D -n Locale-Maketext-Gettext-1.30 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Locale-Maketext-Gettext-1.30/deblicense/
